...
public class DictXMLGenerator  extends OutputStreamWriter {
	...
	public void generate(Collection<ElementDefn> roots, String author) throws Exception
	{
		...
		for (ElementDefn root : roots) {
			...
			writeEntry(root.getName(), 1, 1, Conformance.Mandatory, null, "", root);
	...
	private void writeEntry(String path, Integer min, Integer max, Conformance conformance, List<TypeDefn> types, String conceptDomain, ElementDefn e) throws IOException {
