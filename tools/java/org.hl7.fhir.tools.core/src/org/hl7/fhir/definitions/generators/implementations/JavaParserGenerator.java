...
public class JavaParserGenerator extends JavaBaseGenerator {
	...
	public void generateType(ElementDefn root, ElementDefn e, Map<String, ConceptDomain> conceptDomains) throws Exception {
	...
	private boolean generateTypedElement(Map<String, ConceptDomain> conceptDomains, boolean first, ElementDefn c, String focus, String prefix) throws IOException, Exception {
		if (first)
			write("        	if ");
		else
			write("        	} else if ");
	...
	private boolean generateMultiTypedElement(Map<String, ConceptDomain> conceptDomains, boolean first, ElementDefn c, String focus) throws IOException, Exception {
...
//			}
	...
	private boolean generateUntypedElement(Map<String, ConceptDomain> conceptDomains, boolean first, ElementDefn c, String focus) throws IOException, Exception {
		if (first)
			write("        	if ");
		else
			write("        	} else if ");
    ...
    private boolean hasNestedTypes(ElementDefn root, Map<String, ConceptDomain> conceptDomains) {
	...
	private String getEnumName(ElementDefn e, Map<String, ConceptDomain> conceptDomains) {
